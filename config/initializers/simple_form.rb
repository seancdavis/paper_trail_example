...
SimpleForm.setup do |config|
  ...
  # whole input.
  config.wrappers :default, class: 'input mb-4',
    ...
    b.use :label_input, error_class: 'border-red-600'
  ...
  config.label_class = 'text-sm uppercase font-bold block mb-2 leading-none text-gray-700'
